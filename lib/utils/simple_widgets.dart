...
Widget zTextButton(String text,
    {VoidCallback? onPressed,
    double? width,
    double? height,
    EdgeInsetsGeometry? margin,
...
Widget zImageAsset(String fileName,
    {double? width, double? height, BoxFit? boxFit, bool notPNG = false}) {
  String useblePNG = notPNG ? '' : '.png';
  return Image.asset(
    'assets/$fileName$useblePNG',
...
Widget zSvgImage(String assetName,
    {double? width,
    double? height,
    BoxFit? boxFit,
    Color? color,
...
Widget zSvgNetImage(String imageUrl,
    {double? width,
    double? height,
    BoxFit? boxFit,
    Color? color,
            ...
            case LoadState.failed:
              return GestureDetector(
                child: Stack(
                  ...
                  children: <Widget>[
                    Center(
                      child: zSvgImage(errorImageAssets, width: 50, height: 50),
                    ),
                  ],
                ),
// onTap: () {
